...
ghcr.io/beejeex/cloudflare-dns-dashboard:v2.0.17     # pinned release
```
...
| `v2.0.17` | **Current** — Dashboard live-refresh every 30s (records table + stat cards) without full page reload |
